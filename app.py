...
LEGAL_AUTHORITY_METHOD = (
    ...
    "comparator (the Convention / custom / best practice / another basin); without one it is opinion, "
    "not analysis.\n"
    "SELF-AUDIT — before finalising each analytical paragraph, silently confirm all six: (1) what is "
    "the legal SOURCE; (2) is it BINDING, PERSUASIVE or merely EVIDENTIAL; (3) WHO owes the duty or "
    "holds the power; (4) what THRESHOLD activates the rule; (5) what is PROVED vs merely INFERRED vs "
    "unresolved; (6) have I kept LAW, FACT and POLICY apart. Fix the paragraph before moving on if any "
    "answer is missing or wrong. Then STOP once source + threshold + facts + conclusion are shown — "
    "do not keep arguing a point already won (over-arguing manufactures error).")
LEGAL_METHOD = LEGAL_METHOD + "\n\n" + LEGAL_AUTHORITY_METHOD
...
def answer_question(course, question, include_web=True, fmt="essay", max_out=8000,
    ...
    if mode == "cases":
        ...
        system = (CONFIG["system_prompt"] + "\n\n" + LEGAL_METHOD + "\n\n"
                  ...
                  "REPRODUCE THE LAW VERBATIM, AND FLAG WHERE YOU CANNOT: set out each governing "
                  "provision as its EXACT WORDS, quoted from the retrieved passage in quotation marks, "
