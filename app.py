...
PRECISION_DISCIPLINE = (
    ...
    "the sub-level matters, add 'exact sub-provision to be confirmed against the "
    "Act' (client-facing wording — never 'not in the retrieved material').\n"
    ...
    "one — say 'the Act sets a compensation figure (exact amount to be confirmed)' "
    "rather than writing a convincing '42.63 km²' or 'GH¢1,200', and never phrase it "
    "as 'not in the retrieved material'. A vague-but-true statement always beats a "
