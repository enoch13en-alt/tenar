...
FACT_DISCIPLINE = (
    ...
    "GreenRock is incorporated…'; a stated area ('3,200 hectares') is not an invitation to check a "
    "statutory block-limit unless the facts put it in issue. Analyse a prerequisite ONLY where the "
    ...
    "unless a party pleaded that defect — it applies the law to the facts before the court. STATE "
    "the presumption CRISPLY and once ('where the facts state that a statutory decision has been "
    "made, the law presumes the internal steps leading to it were regularly performed unless the "
    "contrary is alleged, omnia praesumuntur rite et solemniter esse acta') — do NOT enumerate "
    "every internal step (recommendation, statutory notice periods, stamping, registration…); the "
    "list reads mechanical. And having concluded validity, END FIRMLY: do NOT append a "
...
DOCTRINAL_PRECISION = (
    ...
    "- USE THE OPERATIVE STATUTORY TEST, NOT A COMMERCIAL PARAPHRASE. Decide the point on the "
    "instrument's own criterion — 'undertakes the regulated downstream activity', 'engages in "
    "the licensable activity' — not a lay proxy such as 'the visible local seller' or 'the "
    "public face'. A commercial description is not the legal test; frame the operative "
    "requirement in the statute's words.\n"
