...
FACT_DISCIPLINE = (
    ...
    "- ADVISORY REGISTER ON ASSUMED FACTS. State a conclusion drawn on assumed or "
    "incomplete facts in advisory register — 'on the assumed facts, the lease appears "
    "validly ratified and operative, subject to the remaining requirements below' — "
    "not as a flat declaration ('the lease is valid') that then jars against the "
    "qualifications you go on to make.\n"
