...
def answer_question(course, question, include_web=True, fmt="essay", max_out=8000,
    ...
    if mode == "cases":
        ...
        system = (CONFIG["system_prompt"] + "\n\n" + LEGAL_METHOD + "\n\n"
                  ...
                  "REPRODUCE THE LAW, DON'T JUST CITE IT: for each governing provision, set out its "
                  "OPERATIVE CONTENT — what it actually says — as a short accurate quotation or a "
                  "close statement of its terms drawn from the retrieved passage (NEVER paraphrased "
                  "from memory), so the Application has concrete words to apply. Naming 's.12 of Act "
                  ...
                  "operative terms, step by step, to the result. This is where you reason — not "
                  "recite. Distinguish materially different facts (e.g. stool land vs family land) "
